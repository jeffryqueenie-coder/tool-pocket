  ...
  return (
    <ToolLayout toolSlug="markdown-to-html">
      <div className="space-y-4">
        <div>
          <label className="block text-xs font-medium text-muted mb-1.5 font-mono">{t("mdHtml.markdown")}</label>
          <textarea
            ...
            placeholder={t("mdHtml.placeholder")}
            value={input}
        ...
        {output && (
          <div>
            <label className="block text-xs font-medium text-muted mb-1.5 font-mono">{t("mdHtml.output")}</label>
            <textarea
